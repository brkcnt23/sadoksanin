  ...
  <div class="flex items-center justify-between px-1 py-2">
    ...
    <div class="flex items-center gap-1">
      <button
        ...
        class="p-1.5 rounded-md text-ink-600 hover:bg-ink-100 disabled:opacity-40 disabled:cursor-not-allowed"
      >
      ...
      <button
        ...
        :class="[
          ...
          p === page ? 'bg-primary-600 text-white' : 'text-ink-700 hover:bg-ink-100',
          p === '…' ? 'cursor-default' : '',
        ]"
      >
        {{ p }}
