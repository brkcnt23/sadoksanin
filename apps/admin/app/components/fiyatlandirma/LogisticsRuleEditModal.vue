      ...
      <div v-if="isOpen && rule" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-lg max-w-xl w-full">
          ...
          <div class="border-b border-slate-200 px-6 py-4 flex items-center justify-between">
            <div>
              <h2 class="text-lg font-semibold text-slate-900">{{ rule.region }}</h2>
          ...
          <div class="p-6 space-y-4">
            <!-- Base Surcharge -->
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1.5">Sabit Nakliye Ücreti (₺) *</label>
              <input
            ...
            <!-- Per KG Surcharge -->
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1.5">KG Başına Ücret (₺) *</label>
              <input
            ...
            <!-- Per M2 Surcharge -->
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1.5">m² Başına Ücret (₺) *</label>
              <input
            ...
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1.5">Ücretsiz Nakliye Eşiği (₺) (İsteğe Bağlı)</label>
              <input
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-lg p-4 space-y-2">
              <p class="text-xs font-medium text-slate-700">Örnekler:</p>
